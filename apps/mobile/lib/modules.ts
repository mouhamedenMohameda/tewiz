...
export const APP_MODULES: AppModule[] = [
  ...
  { key: 'roadside_assistance', icon: 'shield', label: 'rider.home.modules.roadside_assistance', route: '/(app)/roadside', tint: '#fee2e2', fg: '#dc2626' },
  { key: 'light_moving', icon: 'parcel', label: 'rider.home.modules.light_moving', route: '/(app)/listings?category=light_moving', tint: '#dbeafe', fg: '#0284c7' },
  { key: 'intercity_freight', icon: 'car', label: 'rider.home.modules.intercity_freight', route: '/(app)/freight', tint: '#f3e8ff', fg: '#a855f7' },
  { key: 'equipment_rental', icon: 'tune', label: 'rider.home.modules.equipment_rental', route: '/(app)/listings?category=equipment_rental', tint: '#e0e7ff', fg: '#6366f1' },
